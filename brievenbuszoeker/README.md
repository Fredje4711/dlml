...
- Geeft de kaart geen bruikbaar resultaat, gebruik dan de opvallende knop **Zoek in Google Maps** of controleer de website van de plaatselijke postdienst.

De toepassing toont alleen openbare postbussen voor uitgaande brieven. Organisatie- of klantenbrievenbussen, zoals die van een ziekenfonds, worden uit de resultaten gefilterd. Lichtingstijden worden niet getoond omdat deze kaartinformatie niet overal actueel of volledig is.
